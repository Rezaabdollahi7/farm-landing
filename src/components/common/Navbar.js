...
export default function Navbar() {
    return (
        <Disclosure as="nav" className="bg-red-500 shadow-md">
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    <div className="fixed inset-y-0 left-0 flex items-center sm:hidden">
                        {/* Mobile menu button*/}
                                ...
                                {navigation.map((item) => (
                                    <a
                                        ...
                                        className={classNames(
                                            item.current ? 'bg-green-600 text-white rounded-lg px-6 hover:bg-green-700 transition-colors' : 'text-gray-800 border-b border-transparent hover:border-b hover:border-b-green-600 hover:text-cyan-600 transition-all duration-150',
